// Jane face/skin color-unification test stage 05.
// Subsets: 15 ear, 17 skin Map2, 21 skin Map1.
// Skin 03 is preserved, including specular and rim. Only the pre-ramp dark
// multiplier becomes neutral and remains shared with the face.
...
texture2D ZzzSkinNormalMap1Texture <
    string ResourceName = "textures/Unagi_Body_Map1_N.png";
>;
...
texture2D ZzzSkinNormalMap2Texture <
    string ResourceName = "textures/Unagi_Body_Map2_N.png";
>;
...
texture2D ZzzSkinMaterialMap1Texture <
    string ResourceName = "textures/Unagi_Body_Map1_M.png";
>;
...
texture2D ZzzSkinMaterialMap2Texture <
    string ResourceName = "textures/Unagi_Body_Map2_M.png";
>;
...
texture2D ZzzSkinAuxiliaryMap1Texture <
    string ResourceName = "textures/Unagi_Body_Map1_A.png";
>;
...
texture2D ZzzSkinAuxiliaryMap2Texture <
    string ResourceName = "textures/Unagi_Body_Map2_A.png";
>;
...
ZZZ_SKIN_TECHNIQUE(ZzzSkinRole_15_NoTexture, "object", "15", false, false, true)
ZZZ_SKIN_TECHNIQUE(ZzzSkinRole_15_Texture, "object", "15", true, false, true)
ZZZ_SKIN_TECHNIQUE(ZzzSkinRole_15_ShadowNoTexture, "object_ss", "15", false, true, true)
ZZZ_SKIN_TECHNIQUE(ZzzSkinRole_15_ShadowTexture, "object_ss", "15", true, true, true)
