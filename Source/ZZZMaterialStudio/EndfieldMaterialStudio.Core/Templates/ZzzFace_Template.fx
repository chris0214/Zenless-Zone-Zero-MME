// ZZZ face/skin color-unification test phase 06.
// Face 05 is preserved; only the pre-ramp dark multiplier becomes neutral.

#define ZZZ_FACE_DIFFUSE_RESOURCE "textures/Unagi_Face_D.png"
#define ZZZ_FACE_LIGHT_RESOURCE "textures/Female_Face_lightmap.png"
...
#define ZZZ_FACE_TECHNIQUE(name, passName, useTextureValue) \
    technique name < string MMDPass = passName; string Subset = "0"; \
