// ZZZ eye base manual material. Use one file for iris or eye white subsets.
#define ZZZ_EYE_DIFFUSE_RESOURCE "../textures/common/neutral_base.png"
#define ZZZ_EYE_BASE_SUBSET "0"
...
#define ZZZ_EYE_TECHNIQUE(name, passName, useTextureValue) \
    technique name < string MMDPass = passName; string Subset = ZZZ_EYE_BASE_SUBSET; \
